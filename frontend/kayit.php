...
<div class="container-fluid">
    <div class="header-card mt-4">
        <h1 class="text-center mt-1 fs-2">
            <i class="bi bi-patch-check "></i>Kayıt Ol
        </h1>
        <form>
            <div class="mb-3 text-start ">
                <label for="formGroupExampleInput">Kullanıcı Adınız : </label>
                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Geçerli bir kullanıcı adı giriniz.">
            </div>
            <div class="text-start">
            <label for="exampleInputEmail1">E-mail Adresiniz : </label>
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Geçeli bir mail adresi giriniz."></div>
            <div class="mb-3 text-start">
